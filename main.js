const movies = [
  {
    ...
    trailer:`<iframe width="894" height="503" src="https://www.youtube.com/embed/o5F8MOz_IDw" title="Avatar: The Way of Water | New Trailer" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>`
    ,
    description:
  ...
  trailer:`<iframe width="894" height="503" src="https://www.youtube.com/embed/JfVOs4VSpmA" title="SPIDER-MAN: NO WAY HOME - Official Trailer (HD)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>` 
   ,
    description:
  ...
  },
  {
    ...
    trailer:`<iframe width="894" height="503" src="https://www.youtube.com/embed/giXco2jaZ_4" title="Top Gun: Maverick | NEW Official Trailer (2022 Movie) - Tom Cruise" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>`,
    description:
  ...
  },
  {
    ...
    trailer:`<iframe width="894" height="503" src="https://www.youtube.com/embed/pBk4NYhWNMM" title="Barbie | Main Trailer" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>`,
    description:
  ...
  },
  {
    ...
    trailer:`<iframe width="894" height="503" src="https://www.youtube.com/embed/aWzlQ2N6qqg" title="Marvel Studios&#39; Doctor Strange in the Multiverse of Madness | Official Trailer" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>`,
    description:
  ...
  },
  {
    ...
    trailer:`<iframe width="894" height="503" src="https://www.youtube.com/embed/gbCUoKya2_U" title="The Battle at Lake Changjin | 2021 |  | Official Trailer | [ Chinese ]" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>`,
    description:
  ...
  },
  {
    ...
    trailer:`<iframe width="894" height="503" src="https://www.youtube.com/embed/JqcncLPi9zw" title="Marvel Studios’ Guardians of the Galaxy Vol. 3 | New Trailer" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>`,
    description:
  ...
  },
  {
    ...
    trailer:`<iframe width="894" height="503" src="https://www.youtube.com/embed/fEE4RO-_jug" title="F9 - Official Trailer 2" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>`,
    description:
  ...
  },
  {
    ...
    trailer:`<iframe width="894" height="503" src="https://www.youtube.com/embed/eoOaKN4qCKw" title="FAST X | Final Trailer" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>`,
    description:
...
// const rendier = () => {
  ...
  //     </div>
  //     <div id="add-to-favorite"><svg class="add" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bookmark-fill" viewBox="0 0 16 16">
...
const renderHomePage = () => {
  movies.forEach((ele, i) => {
    const movie = $(`<div class="poster">
      ...
      <div id="add-to-favorite" class="test"><svg class="add ${ele.id}"  xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bookmark-fill" viewBox="0 0 16 16">
      <path d="M2 2v13.5a.5.5 0 0 0 .74.439L8 13.069l5.26 2.87A.5.5 0 0 0 14 15.5V2a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2"/>
    </svg></div>
      </div>
      </div>`);
...
${ele.description}</div>`);
      // const information = $(
      //   `<div id="information"><p>${ele.description}</p></div>`
      // );
      aboutMovie.html("");
      aboutMovie.append(moviePic);
      // aboutMovie.append(information);
...
for (let i=0;i<movies.length;i++){
  if(movies[i].movieName.toLowerCase().includes(searchBar.val().toLowerCase())){
    return movies[i];
  }
}
 return "No result"
...
<div id="search-result-poster-img"></i><img class="movieImage ${search().id}" src=${search().imageSrc}></div>
...
<p>${search().year}</p></div>
  ...
  <div id="add-to-favorite" class="test"><svg class="add ${search().id}"  xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bookmark-fill" viewBox="0 0 16 16">
  <path d="M2 2v13.5a.5.5 0 0 0 .74.439L8 13.069l5.26 2.87A.5.5 0 0 0 14 15.5V2a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2"/>
</svg></div>
</div>
</div>`)
searchPage.append(searchResult);
  ...
  let searchResult=$(`<div id="no-result">No result</div>`)
searchPage.append(searchResult);
}
homePage.hide()
descriptionPage.hide()
